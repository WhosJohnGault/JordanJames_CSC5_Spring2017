...
//prologue/ character introduction sequence
    ...
    std::cout<<"before we begin what is your name?"<<endl; //this will cause a user requested input to prompt
    ...
    cin>>enter;        
    cout<<"Well that was an experience composed of over 100 lines of code..."<<endl;
    cin>>enter;
    string line;
    cout<<"Please write a short review to help us develop in the future!"<<endl;
    char review;
     outfile.open("Review.Dat");
